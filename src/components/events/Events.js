...
const campsData = [
  {
    ...
    description:
      "Join us for the annual NCC parade showcasing discipline and unity.",
  },
  {
    id: 2,
    ...
    description:
      "Enhance your leadership skills at our NCC leadership workshop.",
  },
  {
    id: 3,
...
const Events = () => {
  ...
  useEffect(() => {
    const toggleHidden = () => {
      const hiddenCards = upcomingCampsGridRef.current.querySelectorAll(
        ".upcoming-camp-card.hidden"
      );
    ...
    upcomingCampsGridRef.current.addEventListener(
      "animationiteration",
      handleAnimationIteration
    );

    return () => {
      upcomingCampsGridRef.current.removeEventListener(
        "animationiteration",
        handleAnimationIteration
      );
    };
  ...
  return (
    <>
      ...
      <div className="upcoming-camps-container">
        <h1 className="upcoming-camps-title">
